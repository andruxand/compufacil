                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-12 table-responsive">
                            <table id="results" class="table table-hover table-sm table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <th class="text-center" scope="col">PRE-ESCOLAR Y PRIMARIA</th>
                                        ...
                                        <td class="text-center" scope="col"><label id="pp_5_1"></label></td>
                                        <td class="text-center" scope="col"><label id="pp_5_2"></label></td>
                                        <td class="text-center" scope="col"><label id="pp_5_3"></label></td>
                                        <td class="text-center" scope="col"><label id="pp_5_4"></label></td>
                                        <td class="text-center" scope="col"><label id="pp_5_5"></label></td>  
                                    </tr>  
                                    <tr>
                                        <th class="text-center" scope="col">SECUNDARIA</th>
                                        ...
                                        <td class="text-center" scope="col"><label id="s_5_1"></label></td>
                                        <td class="text-center" scope="col"><label id="s_5_2"></label></td>
                                        <td class="text-center" scope="col"><label id="s_5_3"></label></td>
                                        <td class="text-center" scope="col"><label id="s_5_4"></label></td>
                                        <td class="text-center" scope="col"><label id="s_5_5"></label></td>  
                                    </tr> 
                                    <tr>
                                        ...
                                        <td class="text-center" scope="col"><label id="t_5_1"></label></td>
                                        <td class="text-center" scope="col"><label id="t_5_2"></label></td>
                                        <td class="text-center" scope="col"><label id="t_5_3"></label></td>
                                        <td class="text-center" scope="col"><label id="t_5_4"></label></td>
                                        <td class="text-center" scope="col"><label id="t_5_5"></label></td> 
                                    </tr> 
                                </tbody>
                            </table>
                        </div>     
