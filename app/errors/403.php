...
<html lang="es">
     <head>
        ...
        <style>
            ...
            h1 span {color: #bbb;}
            h2 {color: #2e6da4;margin: 0 10px;font-size: 40px;text-align: center;}
    ...
    <body>
        <div class="container">
            <h2><span>403</span><div style="width: 100%">No tiene permisos</div></h2>
            <p>Lo sentimos! <br><br> Usted no cuenta con los permisos necesarios para acceder a esta página.</p>
        </div>
    </body>
</html>